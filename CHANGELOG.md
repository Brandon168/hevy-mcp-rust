...
- Added `hevy-cli`, a direct command-line Hevy API client for workouts,
  routines, routine folders, exercise templates, exercise history, webhooks,
  and JSON exports.
- Added an agent skill wrapper for `hevy-cli`.
- Added GitHub CI for push and pull request validation.
- Updated release automation to publish both `hevy-mcp-*` and `hevy-cli-*`
  binaries.
